...
export default function Institutional() {
  return (
    <section className="bg-[#1a1a1a] py-[100px] flex justify-center w-full relative overflow-hidden">
      {/* Top transition mask */}
      <div className="absolute top-0 left-0 right-0 h-[100px] bg-gradient-to-b from-[#F0FDF4] to-transparent pointer-events-none" />

      {/* Bottom transition mask */}
      <div className="absolute bottom-0 left-0 right-0 h-[100px] bg-gradient-to-t from-[#FFF7ED] to-transparent pointer-events-none" />
